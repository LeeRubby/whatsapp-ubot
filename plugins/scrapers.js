...
Asena.addCommand({ pattern: 'ripaudio ?(.*)', fromMe: true, desc: Lang.SONG_DESC }, (async(message, match) => {
...
Asena.addCommand({ pattern: 'ripvideo ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC }, (async(message, match) => {
